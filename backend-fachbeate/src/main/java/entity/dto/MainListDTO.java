...
public class MainListDTO {
    ...
    public MainListDTO mapCustomerToMainListDTO(CustomerRequirement element){
        ...
        this.statusGL= (element.releaseManagement!=null) ? "GL Freigegeben" : "GL Nicht-Freigegeben";
        this.statusAL= (element.releaseSupervisor!=null) ? "AL Freigegeben" : "AL Nicht-Freigegeben";
